          ...
          {list.map((item, index) => (
            <React.Fragment key={item.title}>
              <Link href={item.link} target="_blank" rel="noopener noreferrer">
                <span className="hover:underline text-2xl font-bold font-kagitingan">
                  {item.title}
                </span>
              </Link>
              {index !== list.length - 1 && (
            ...
            {[
              {
                ...
                href: 'https://www.instagram.com/techtrix_official',
              },
              {
              ...
              },
              {
                ...
                href: 'https://linkedin.com/company/techtrix-rcciit',
              },
            ].map((social, index) => (
              <Link
                key={index}
